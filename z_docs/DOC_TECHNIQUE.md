...
| `BASE/api/health/mcp-notion` | Endpoint de santé Notion côté backend (l’interface **Notion n’est pas exposée** dans l’app actuelle) |
...
- **Assistant IA** intégré (chat, historique de conversations)
...
- `z_docs/14-guide-configuration-mcp.md` — checklist configuration
...
*Dernière mise à jour : alignée sur les URLs de production ci-dessus.*
